...
import { MAX_COLOR_SATURATION, MAX_COLOR_VALUE } from '@uifabric/utilities/color/consts';
import { getFullColorString } from '@uifabric/utilities/color/getFullColorString';
import { updateSV } from '@uifabric/utilities/color/updateSV';
import { clamp } from '@uifabric/utilities/color/clamp';
