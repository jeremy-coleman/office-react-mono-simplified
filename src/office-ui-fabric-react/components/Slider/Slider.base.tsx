...
import { BaseComponent, KeyCodes, css, getId, getRTL, getRTLSafeKeyCode } from '@uifabric/utilities';
import { ISliderProps, ISlider, ISliderStyleProps, ISliderStyles } from './Slider.types';
import { classNamesFunction, getNativeProps, divProperties } from '@uifabric/utilities';
